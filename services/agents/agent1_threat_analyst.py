...
async def run() -> None:
    ...
    async for message in pubsub.listen():
        ...
        try:
            ...
            if not alert_id:
                logger.warning("Message missing alert id: %s", message["data"])
                continue
            ...
            # Fetch triggering event for src_ip context
            ...
            # Fetch recent alerts from same src_ip
            ...
            # Serialise datetime/uuid fields
            publish_payload = {
